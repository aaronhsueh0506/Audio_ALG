"""Validate temporal padding in stateless streaming ONNX graphs.
...
This module lives inside ``AINR`` because that directory is a standalone
release unit used on training and quantization machines.
"""
