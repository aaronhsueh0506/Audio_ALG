...
單檔:
    python inference.py --config config.ini --model output/dfn3_best.pth \
...
def load_model(args):
    ...
    model = DeepFilterNet3(**model_cfg)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='DeepFilterNet3 推論')
