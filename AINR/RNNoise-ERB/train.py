...
def train(args):
    ...
    for epoch in range(start_epoch, epochs + 1):
        ...
        ckpt = {
            ...
            # Scheduler is rebuilt/fast-forwarded on resume so a stale T_max
            # cannot survive an epochs or loader-length change.
            'loss': avg_val,
            'best_val_loss': checkpoint_best,
            'no_improve_count': 0 if is_best else no_improve_count + 1,
