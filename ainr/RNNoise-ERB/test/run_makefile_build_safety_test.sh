...
# dependency on audio_common/AEC/NR -- these are RNNoise-ERB's OWN Makefile
...
#    audio_common's/AEC's/NR's/Audio_ALG's own Makefiles (adapted for this
...
#
# Style/convention reference: AEC/c_impl/test/run_fp_flag_policy_test.sh
