...
if __name__ == '__main__':
    ...
    # six trainers in ainr/ sharing one seed IS load-bearing -- it is what makes the
    # train/val split identical across models, and in the AEC cascade a stage-1
    # model split differently from the stage-2 model that consumes it would leak
    # stage-2's validation set into stage-1 training.  Enforced by
