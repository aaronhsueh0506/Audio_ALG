...
# ============================================================
# ERB Band 工具 (inlined copy — see "Standalone note" above)
# ============================================================
...
class DNS4Dataset(Dataset):
    ...
    def _compute_erb_bands(self):
        # NOTE: compute_hybrid_bands/compute_erb_bands are defined in this same
        # module (top of file) — inlined so this package has no dependency on
        # any model repo's train.py. See "Standalone note" in the module docstring.
