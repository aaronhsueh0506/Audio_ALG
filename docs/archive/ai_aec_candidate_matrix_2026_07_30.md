# Archived AI-AEC candidate research record (2026-07-30)

> **Archived:** this document preserves the reasoning and implementation
> history before the repository moved to the six candidates under `AIAEC/`.
> Removed paths and prototype names below are intentional historical evidence,
> not current setup instructions. Use
> [`../ai_aec_candidate_matrix.md`](../ai_aec_candidate_matrix.md) for the
