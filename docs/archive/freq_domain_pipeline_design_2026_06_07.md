# Archived frequency-domain pipeline design (2026-06-07)

> This document predates the implemented unified gain-fusion path and contains
> old grid/API descriptions. Use
> [`../freq_domain_pipeline_design.md`](../freq_domain_pipeline_design.md) and
> [`../../pipelines/README.md`](../../pipelines/README.md) for the current
> contract.

## Original proposal: AEC(linear) → NR → AEC(residual)
