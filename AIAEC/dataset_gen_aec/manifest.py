...
----------------------------
``dataset_gen/loader.py`` splits the *generated* corpus: it draws a permutation
...
from dataset_gen.dataset import estimate_rt60
...
def _rir_rt60(root: str, rel_paths: Sequence[str], sr: int,
    ...
    record of which RIRs the corpus may use.  ``dataset_gen/dataset.py`` caches
