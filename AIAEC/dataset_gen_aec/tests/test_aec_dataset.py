...
from dataset_gen_aec.aec_dataset import (  # noqa: E402
    AecSequenceRenderer,
    SequencePlan,
    plan_sequences,
    resample_by_ratio,
...
from dataset_gen_aec.gen_aec_dataset import gen_aec_dataset  # noqa: E402
from dataset_gen_aec.manifest import (  # noqa: E402
    build_manifest,
    load_manifest,
    pools_for_split,
)
from dataset_gen_aec.pack_aec_dataset import pack  # noqa: E402
from dataset_gen_aec.packed_aec_dataset import PackedAecDataset  # noqa: E402
...
def test_metadata_covers_the_declared_contract(packed):
    ...
    from dataset_gen_aec.aec_dataset import SCENARIOS
    dataset = packed['train']
    for index in range(len(dataset)):
        meta = dataset.meta(index)
...
def test_manifest_round_trips(corpus, tmp_path):
    from dataset_gen_aec.manifest import save_manifest
