...
Unlike ``dataset_gen/packed_dataset.py``, this does NOT hand a directory to
...
class PackedAecDataset(Dataset):
    ...
    :class:`~dataset_gen_aec.aec_features.AecStems` to read channels by name --
    ...
    def __init__(self, path: str, expected_sr: Optional[int] = None,
        ...
        for shard_path in self.paths:
            # ⚠ weights_only=False, unlike dataset_gen/packed_dataset.py.  The
