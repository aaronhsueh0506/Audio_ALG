#!/usr/bin/env python3
"""CAGCRN inference -- run a trained checkpoint on one mic/far-end pair.
...
Output is the clean near-end speech estimate (unlike DeepVQE_S, CAGCRN's
published task does not include dereverberation).
