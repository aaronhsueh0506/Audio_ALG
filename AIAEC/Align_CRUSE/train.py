...
config.ini sections (see the shipped config.ini for every knob, documented):
    ...
    [loss]     paper PLCPA weights and STFT-consistency switch
...
def main(args):
    ...
    lr = cfg.getfloat('training', 'lr', fallback=1.5e-4)
    ...
    optimizer = torch.optim.Adam(
        ...
        weight_decay=cfg.getfloat('training', 'weight_decay', fallback=5e-6),
