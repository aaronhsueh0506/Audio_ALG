#!/usr/bin/env python3
"""GTCRN-AENR inference -- run a trained checkpoint on one mic/far-end pair.
...
mic.wav / far.wav must be mono. This candidate is locked to the upstream
16 kHz grid, so both inputs are resampled to 16 kHz before the linear AEC when
needed; output stays at 16 kHz.
