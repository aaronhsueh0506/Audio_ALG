...
# ⚠ ainr/ is a SIBLING tree now, not this project's parent.  Before AIAEC/ was
# split out, dirname(ROOT) happened to be ainr/; it is AIAEC/ today, so this
# resolved to our own model.py and the cross-project comparison below silently
# compared the file against itself.
AIAEC = os.path.dirname(ROOT)
AINR = os.path.join(os.path.dirname(AIAEC), 'ainr')
