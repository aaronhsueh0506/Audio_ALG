...
from dataset_gen_aec import AecGrid, frames_from_seconds  # noqa: E402
...
# into frames by ``dataset_gen_aec.frames_from_seconds``, which all three AEC
...
def reset_state(state: Dict[str, torch.Tensor],
    ...
    Used with ``dataset_gen_aec.lane_reset_mask`` when a lane moves on to a new
